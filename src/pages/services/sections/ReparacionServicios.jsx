        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Reparación Profesional de Equipos de Hostelería
            </h2>
          ...
          <div className="flex flex-col justify-center">
            <p className="text-gray-500 text-base mb-6">
              Especializados en la reparación y servicio técnico de equipos de hostelería en Palma de Mallorca. Ofrecemos reparación rápida y eficiente de hornos, lavavajillas, planchas, neveras y equipos de acero inoxidable para restaurantes y hoteles.
            </p>
          </div>
        </div>
          ...
          <div className="relative">
            <div className="relative h-full">
              ...
              <div className="absolute bottom-2 left-2 lg:bottom-4 lg:left-4 bg-white rounded-lg p-2 lg:p-4 shadow-lg max-w-[200px] lg:max-w-xs">
                ...
                <h3 className="text-gray-800 font-semibold mb-1 text-xs lg:text-sm">Reparación Garantizada</h3>
                <p className="text-[10px] lg:text-xs text-gray-600">Atención Post-Reparación.</p>
              </div>
            </div>
          </div>
...
export default ReparacionServicios;
