...
export default function MesasPara4PersonasRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas para 4 personas para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con materiales de primera calidad, resistentes y duraderas para restaurantes profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué medidas tienen las mesas para 4 personas?",
      answer:
        "Nuestras mesas para 4 personas tienen medidas estándar de 120x80 cm o 140x80 cm, pero podemos fabricar mesas personalizadas según tus necesidades específicas de espacio en el restaurante.",
    },
    {
      question: "¿Las mesas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en restaurantes profesionales sin deteriorarse.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Para 4 Personas Restaurante"
        description="Mesas para 4 personas para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería."
        keywords="mesas 4 personas restaurante, mesas inox restaurante, mobiliario restaurante, mesas gastronomia, mesas inox bar"
        canonical="/mesas-para-4-personas-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Para 4 Personas <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas para 4 personas para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas para 4 personas para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas para 4 personas para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas para 4 personas diseñadas específicamente para restaurantes profesionales en el sector
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas para 4 personas para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas para 4 personas ofrecen higiene máxima y resistencia excepcional para restaurantes
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas para 4 personas para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas para 4 personas están fabricadas con materiales de primera calidad que garantizan
