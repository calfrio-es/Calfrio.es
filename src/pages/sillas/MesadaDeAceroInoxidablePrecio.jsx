...
export default function MesadaDeAceroInoxidablePrecio() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesadas de acero inoxidable. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesadas fabricadas con acero inoxidable de primera calidad, resistentes y duraderas para cocinas profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Cuáles son los precios de las mesadas de acero inoxidable?",
      answer:
        "Nuestros precios varían según las medidas y el grosor. Mesadas estándar desde 150€/metro lineal. Contacta con nosotros para obtener un presupuesto personalizado sin compromiso.",
    },
    {
      question: "¿Las mesadas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesadas de acero inoxidable resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en cocinas profesionales sin deteriorarse.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, todas nuestras mesadas incluyen instalación profesional por parte de nuestro equipo técnico especializado. Nos aseguramos de que queden perfectamente niveladas y listas para su uso inmediato.",
    },
  ]
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesada De Acero Inoxidable Precio"
        description="Mesadas de acero inoxidable precio para cocinas profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="mesadas acero inoxidable precio, mesadas inox precio cocinas, mobiliario cocina acero precio, mesadas acero inoxidable gastronomia precio, mesadas inox bar precio"
        canonical="/mesada-de-acero-inoxidable-precio"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesada De Acero Inoxidable <span className="text-cyan-600">Precio</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesadas de acero inoxidable precio para cocinas profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en conocer los precios de mesadas de acero inoxidable para mi cocina. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesadas de acero inoxidable para mi cocina. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesadas de acero inoxidable con los mejores precios del mercado para cocinas profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con acero inoxidable 304 de grado alimenticio, nuestras mesadas
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesadas de acero inoxidable precio para cocinas profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesadas de acero inoxidable ofrecen higiene máxima y resistencia excepcional para cocinas
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesadas de acero inoxidable para tu cocina?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesadas están fabricadas con acero inoxidable 304 de grado alimenticio que garantiza
