...
export default function SillaDeBares() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas de bares. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas fabricadas con materiales de primera calidad y diseño moderno para bares.",
      image: bancoBarAcero4,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario de bares.",
  ...
  const faqs = [
    {
      question: "¿Qué tipos de sillas ofrecen para bares?",
      answer:
        "Ofrecemos una amplia variedad de sillas para bares: sillas altas, taburetes, sillas con respaldo, sillas tapizadas, sillas de madera, metal y plástico. Cada tipo está diseñado para diferentes estilos de decoración y necesidades de comodidad.",
    },
    {
      question: "¿Las sillas son cómodas para estar mucho tiempo sentado?",
      answer:
        "Sí, nuestras sillas están diseñadas con ergonomía profesional. Incluyen respaldos apropiados, asientos acolchados y alturas ideales para barras de bar, permitiendo comodidad incluso en largas estancias.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Silla De Bares"
        description="Sillas de bares de alta calidad. Comodidad, resistencia y diseño moderno para establecimientos hosteleros."
        keywords="silla de bares, sillas bares, mobiliario bares, sillas hostelería, sillas modernas bares"
        canonical="/silla-de-bares"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Silla De <span className="text-cyan-600">Bares</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas diseñadas específicamente para bares. Comodidad, resistencia y diseño moderno para tu establecimiento hostelero
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas de bares. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas de bares. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una amplia gama de sillas de bares diseñadas específicamente para el sector hostelero.
              Nuestras sillas combinan comodidad ergonómica con máxima durabilidad, utilizando materiales premium como
              acero inoxidable, madera maciza y tapizados de alta resistencia. Cada silla está pensada para resistir
              el alto tránsito de bares, manteniendo su elegancia con el paso del tiempo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas de bares en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas de bares combinan diseño contemporáneo con ergonomía perfecta, creando espacios
                  cómodos que invitan a tus clientes a permanecer más tiempo en tu establecimiento.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas de bares con diseño funcional"
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras sillas están fabricadas con materiales de primera calidad que resisten el uso intensivo
                  de entornos hosteleros. Diseñadas para durar años manteniendo su comodidad y apariencia.
                </p>
