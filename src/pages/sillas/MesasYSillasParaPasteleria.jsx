...
export default function MesasYSillasParaPasteleria() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas para pastelería. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con materiales elegantes para pastelerías.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario para pastelerías.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipo de mesas recomiendan para pastelerías?",
      answer:
        "Recomendamos mesas con diseños elegantes y delicados, superficies fáciles de limpiar, con acabados que combinen con la decoración dulce y acogedora típica de las pastelerías.",
    },
    {
      question: "¿Son adecuadas para ambientes familiares?",
      answer:
        "Sí, nuestras mesas y sillas para pastelerías están diseñadas para crear ambientes acogedores y familiares, perfectos para disfrutar de postres y cafés.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Pasteleria"
        description="Mesas y sillas para pastelerías profesionales. Higiene, resistencia y durabilidad máxima. Ideales para ambientes acogedores."
        keywords="mesas sillas pasteleria, mesas cafeteria pastelera, mobiliario pasteleria, mesas gastronomia pastelera, mesas bar pasteleria"
        canonical="/mesas-y-sillas-para-pasteleria"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para <span className="text-cyan-600">Pastelería</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas para pastelerías profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas para mi pastelería. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas para mi pastelería. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas diseñadas específicamente para pastelerías y cafeterías en el sector
              de la restauración dulce. Fabricadas con materiales elegantes y delicados, nuestras mesas y sillas
              garantizan higiene máxima, resistencia y facilidad de limpieza. Ideales para pastelerías,
              cafeterías, heladerías y cualquier establecimiento que busque crear ambientes acogedores y familiares.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas para pastelerías profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas para pastelerías ofrecen higiene máxima y resistencia excepcional.
                  Superficies elegantes que facilitan la limpieza y crean ambientes acogedores.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas para tu pastelería?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas para pastelerías están fabricadas con materiales elegantes y delicados que garantizan
                  higiene máxima y durabilidad. Diseñadas para crear ambientes acogedores y familiares.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Diseños elegantes y delicados</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Adecuadas para ambientes familiares</span>
                  </li>
                </ul>
              </div>
            </div>
