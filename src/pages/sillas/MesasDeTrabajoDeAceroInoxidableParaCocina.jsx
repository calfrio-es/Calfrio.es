...
export default function MesasDeTrabajoDeAceroInoxidableParaCocina() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas de trabajo de acero inoxidable para cocina. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con acero inoxidable de primera calidad, resistentes y duraderas para cocinas profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Sí, nuestras mesas de trabajo de acero inoxidable resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en cocinas profesionales sin deteriorarse.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas De Trabajo De Acero Inoxidable Para Cocina"
        description="Mesas de trabajo de acero inoxidable para cocinas profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería."
        keywords="mesas trabajo acero inoxidable cocina, mesas inox trabajo cocinas, mobiliario cocina acero, mesas acero inoxidable gastronomia, mesas inox bar"
        canonical="/mesas-de-trabajo-de-acero-inoxidable-para-cocina"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas De Trabajo De Acero Inoxidable Para <span className="text-cyan-600">Cocina</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas de trabajo de acero inoxidable para cocinas profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas de trabajo de acero inoxidable para mi cocina. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas de trabajo de acero inoxidable para mi cocina. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas de trabajo de acero inoxidable diseñadas específicamente para cocinas profesionales en el sector
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas de trabajo de acero inoxidable para cocinas profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas de trabajo de acero inoxidable ofrecen higiene máxima y resistencia excepcional para cocinas
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas de trabajo de acero inoxidable para tu cocina?</h2>
