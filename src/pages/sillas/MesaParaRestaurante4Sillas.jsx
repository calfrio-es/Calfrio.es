...
export default function MesaParaRestaurante4Sillas() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas para restaurante de 4 sillas. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas con 4 sillas fabricadas con materiales de primera calidad, resistentes y duraderas para restaurantes profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué medidas tienen las mesas de 4 sillas para restaurante?",
      answer:
        "Nuestras mesas de 4 sillas tienen medidas estándar de 120x80 cm, pero podemos fabricar mesas personalizadas según tus necesidades específicas de espacio en el restaurante.",
    },
    {
      question: "¿Las mesas y sillas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas y sillas resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en restaurantes profesionales sin deteriorarse.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, todas nuestras mesas de 4 sillas incluyen instalación profesional por parte de nuestro equipo técnico especializado. Nos aseguramos de que queden perfectamente niveladas y listas para su uso inmediato.",
    },
  ]
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesa Para Restaurante 4 Sillas"
        description="Mesas para restaurante de 4 sillas. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="mesas restaurante 4 sillas, mesas inox restaurante, mobiliario restaurante, mesas gastronomia, mesas inox restaurante"
        canonical="/mesa-para-restaurante-4-sillas"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesa Para Restaurante <span className="text-cyan-600">4 Sillas</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas para restaurante de 4 sillas. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas de 4 sillas para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas de 4 sillas para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas de 4 sillas diseñadas específicamente para restaurantes profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con materiales de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para restaurantes,
              cafeterías y cualquier establecimiento que requiera estándares higiénicos profesionales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas para restaurante de 4 sillas profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas de 4 sillas ofrecen higiene máxima y resistencia excepcional para restaurantes
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas de 4 sillas para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas de 4 sillas están fabricadas con materiales de primera calidad que garantizan
