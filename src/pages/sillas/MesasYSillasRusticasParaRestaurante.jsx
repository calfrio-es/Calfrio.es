...
export default function MesasYSillasRusticasParaRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas rústicas para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Rusticas Para Restaurante"
        description="Mesas y sillas rústicas para restaurante con estilo industrial y natural. Higiene, resistencia y durabilidad máxima."
        keywords="mesas sillas rusticas restaurante, mesas madera restaurante, mobiliario rustico restaurante, mesas industrial restaurante, mesas naturales restaurante"
        canonical="/mesas-y-sillas-rusticas-para-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Rústicas Para <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas rústicas para restaurante con estilo industrial y natural. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas rústicas para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas rústicas para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas rústicas diseñadas específicamente para restaurantes con decoración industrial o natural en el sector
              ...
              garantizan higiene máxima, resistencia al desgaste y un carácter único. Ideales para restaurantes temáticos,
              locales tradicionales y cualquier establecimiento que busque un ambiente cálido y auténtico.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas rústicas para restaurante con estilo industrial y natural"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas rústicas ofrecen higiene máxima y resistencia excepcional para restaurantes.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas rústicas para tu restaurante?</h2>
