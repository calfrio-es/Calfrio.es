...
export default function SillasModernasParaBarras() {
  const [openFaq, setOpenFaq] = useState(null)
  const benefits = [
    { icon: <Clock className="w-8 h-8" />, title: "Entrega Inmediata", description: "Disponibilidad inmediata de nuestras sillas modernas para barras.", image: sillaBarAcero2 },
    { icon: <CheckCircle className="w-8 h-8" />, title: "Calidad Premium", description: "Sillas modernas específicamente diseñadas para barras y mostradores.", image: bancoBarAcero4 },
  ...
  const faqs = [
    { question: "¿Qué alturas ofrecen para barras?", answer: "Ofrecemos sillas con alturas específicas para barras (75-80cm) y alturas estándar para mesas (45-50cm)." },
    { question: "¿Son estables en barras altas?", answer: "Sí, nuestras sillas están diseñadas con bases anchas y pesos equilibrados para máxima estabilidad en barras." },
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO title="Sillas Modernas Para Barras" description="Sillas modernas para barras. Altura perfecta y diseño contemporáneo. Comodidad en altura." keywords="sillas modernas barras, sillas altura barra, mobiliario moderno barras, sillas altas modernas" canonical="/sillas-modernas-para-barras" />
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Sillas Modernas Para <span className="text-cyan-600">Barras</span></h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">Sillas modernas con altura perfecta para barras. Diseño contemporáneo y máxima estabilidad</p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => { const phoneNumber = '+573167137081'; const message = 'Hola, estoy interesado en sillas modernas para barras. ¿Podrían asesorarme?'; const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`; window.open(whatsappUrl, '_blank') }} className="inline-block bg-cyan-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-cyan-700 transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">Solicitar Presupuesto</button>
            <button onClick={() => { const phoneNumber = '+573167137081'; const message = 'Hola, quiero comprar sillas modernas para barras. ¿Me pueden ayudar?'; const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`; window.open(whatsappUrl, '_blank') }} className="inline-block bg-white text-cyan-600 border-2 border-cyan-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-cyan-50 transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">Comprar</button>
          </div>
        </div>
      </section>
      <section className="py-2 px-4 sm:px-6 lg:px-2">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">Ofrecemos sillas modernas específicamente diseñadas para barras, con alturas perfectas (75-80cm) y diseños contemporáneos que combinan estabilidad con estilo moderno. Nuestras sillas garantizan comodidad en altura manteniendo la elegancia de tu establecimiento.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src={bancoBarModerno} alt="Sillas modernas para barras" className="w-full h-[400px] sm:h-[500px] object-cover" />
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">Nuestras sillas modernas para barras ofrecen la altura ideal y máxima estabilidad.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas sillas modernas para barras?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img src={bancoBarAcero1} alt="Sillas modernas para barras altas" className="h-full w-full object-cover" />
              </div>
              <div className="flex flex-col justify-center p-8 md:p-12">
                <h3 className="mb-4 text-3xl font-bold text-white">Calidad y Durabilidad Premium</h3>
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">Nuestras sillas modernas para barras están fabricadas con materiales de primera calidad y alturas específicas.</p>
