...
export default function BancosParaBarraDeCantina() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestros bancos para barra de cantina. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Bancos fabricados con materiales de primera calidad y diseño moderno para cantinas.",
      image: bancoBarAcero4,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario de cantinas.",
  ...
  const faqs = [
    {
      ...
      answer:
        "Utilizamos materiales premium como acero inoxidable, madera maciza tratada y tapizados de alta resistencia. Todos nuestros bancos están diseñados específicamente para entornos de cantinas con alto tránsito.",
    },
    {
      question: "¿Los bancos son apilables o fijos?",
      answer:
        "Ofrecemos ambas opciones: bancos fijos para instalación permanente y bancos apilables para mayor versatilidad. Los apilables facilitan el almacenamiento y limpieza de la cantina.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Bancos Para Barra De Cantina"
        description="Bancos para barra de cantina. Diseño funcional y resistente para ambientes de alta demanda. Materiales duraderos y máxima comodidad."
        keywords="bancos para barra de cantina, bancos cantina, mobiliario cantina, bancos barra cantina, bancos acero inoxidable cantina"
        canonical="/bancos-para-barra-de-cantina"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Bancos Para Barra De <span className="text-cyan-600">Cantina</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Soluciones de mobiliario resistente para cantinas. Diseño funcional y materiales duraderos para alta demanda
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en bancos para barra de cantina. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar bancos para barra de cantina. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una amplia gama de bancos para barra de cantina diseñados específicamente para el sector hostelero.
              Nuestros bancos combinan diseño funcional con máxima durabilidad, utilizando materiales premium como
              acero inoxidable, madera maciza y tapizados de alta resistencia. Cada pieza está pensada para resistir
              el alto tránsito de cantinas, manteniendo su elegancia con el paso del tiempo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Bancos para barra de cantina en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestros bancos para cantina combinan funcionalidad práctica con resistencia excepcional, creando espacios
                  cómodos que soportan el uso intensivo diario de tu establecimiento.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas bancos para tu cantina?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Bancos para barra de cantina con diseño funcional"
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  ...
                  de entornos de cantinas. Diseñados para durar años manteniendo su apariencia funcional.
                </p>
