...
export default function MesasDePlasticoParaNegocio() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas de plástico para negocio. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con plástico resistente de primera calidad, duraderas para negocios profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipos de mesas de plástico ofrecen?",
      answer:
        "Ofrecemos mesas con superficies de plástico resistente al impacto, fáciles de limpiar y disponibles en diferentes colores, ideales para negocios con alto tráfico de clientes.",
    },
    {
      question: "¿Las mesas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas de plástico resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en negocios profesionales sin deteriorarse.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas De Plastico Para Negocio"
        description="Mesas de plástico para negocios profesionales. Higiene, resistencia y durabilidad máxima. Ideales para comercios."
        keywords="mesas plastico negocio, mesas resistentes negocio, mobiliario comercial plastico, mesas gastronomia, mesas bar"
        canonical="/mesas-de-plastico-para-negocio"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas De Plástico Para <span className="text-cyan-600">Negocio</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas de plástico para negocios profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas de plástico para mi negocio. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas de plástico para mi negocio. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas de plástico diseñadas específicamente para negocios profesionales en el sector
              comercial. Fabricadas con plástico resistente de primera calidad, nuestras mesas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para negocios,
              comercios y cualquier establecimiento que requiera mobiliario duradero y fácil mantenimiento.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas de plástico para negocios profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas de plástico ofrecen higiene máxima y resistencia excepcional para negocios
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas de plástico para tu negocio?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas están fabricadas con plástico resistente de primera calidad que garantiza
