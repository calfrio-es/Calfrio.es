...
export default function Mesa4SillasParaRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas de 4 sillas para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué medidas tienen las mesas de 4 sillas?",
      answer:
        "Nuestras mesas de 4 sillas tienen medidas estándar de 120x80 cm, pero podemos fabricar mesas personalizadas según tus necesidades específicas de espacio.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesa 4 Sillas Para Restaurante"
        description="Mesas de 4 sillas para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="mesas 4 sillas restaurante, mesas inox restaurante, mobiliario restaurante, mesas gastronomia, mesas inox restaurante"
        canonical="/mesa-4-sillas-para-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesa 4 Sillas Para <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas de 4 sillas para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas de 4 sillas para restaurantes profesionales"
