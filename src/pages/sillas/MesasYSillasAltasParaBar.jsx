...
export default function MesasYSillasAltasParaBar() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas altas para bar. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con materiales de primera calidad, resistentes y duraderas para bares.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué alturas tienen las mesas y sillas altas?",
      answer:
        "Las mesas altas de bar miden entre 90-110cm y las sillas altas tienen asientos a 75-85cm del suelo, ideales para barras y espacios reducidos.",
    },
    {
      question: "¿Las mesas y sillas altas son estables?",
      answer:
        "Sí, nuestras mesas y sillas altas están diseñadas con bases reforzadas y sistemas de estabilidad que garantizan seguridad incluso en espacios concurridos.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Altas Para Bar"
        description="Mesas y sillas altas para bar profesionales. Higiene, resistencia y durabilidad máxima. Ideales para barras y espacios reducidos."
        keywords="mesas sillas altas bar, mesas bar altas, mobiliario bar alto, mesas gastronomia bar, mesas inox bar altas"
        canonical="/mesas-y-sillas-altas-para-bar"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Altas Para <span className="text-cyan-600">Bar</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas altas para bar profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas altas para mi bar. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas altas para mi bar. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas altas para bar diseñadas específicamente para barras y espacios reducidos en el sector
              de la hostelería y gastronomía. Fabricadas con materiales de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para bares,
              pubs, cafeterías y cualquier establecimiento que necesite optimizar el espacio.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas altas para bar profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas altas ofrecen higiene máxima y resistencia excepcional para bares.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas altas para tu bar?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas altas están fabricadas con materiales de primera calidad que garantizan
