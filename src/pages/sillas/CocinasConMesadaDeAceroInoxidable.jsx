...
export default function CocinasConMesadaDeAceroInoxidable() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras cocinas con mesada de acero inoxidable. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Cocinas fabricadas con mesadas de acero inoxidable de primera calidad, resistentes y duraderas para cocinas profesionales.",
      image: mesaBarAcero5,
    },
    {
    ...
    },
    {
      ...
      description: "Garantía de 2 años en estructura y acabados. Resistencia anticorrosiva certificada.",
      image: mesaBar5,
    },
  ]
  ...
  const faqs = [
    {
      question: "¿Qué tipo de acero inoxidable utilizan en las mesadas?",
      answer:
        "Utilizamos acero inoxidable 304 de grado alimenticio en todas nuestras mesadas, resistente a la corrosión, fácil de limpiar y aprobado para uso en cocinas profesionales. Este material cumple con todas las normativas sanitarias.",
    },
    {
      question: "¿Las cocinas con mesada de acero inoxidable son resistentes a productos químicos?",
      answer:
        "Sí, nuestras cocinas con mesadas de acero inoxidable resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en cocinas profesionales sin deteriorarse.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, todas nuestras cocinas incluyen instalación profesional por parte de nuestro equipo técnico especializado. Nos aseguramos de que queden perfectamente niveladas y listas para su uso inmediato.",
    },
  ]
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Cocinas Con Mesada De Acero Inoxidable"
        description="Cocinas con mesada de acero inoxidable para cocinas profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="cocinas mesada acero inoxidable, cocinas inox mesadas, mobiliario cocina acero, cocinas acero inoxidable gastronomia, cocinas inox bar"
        canonical="/cocinas-con-mesada-de-acero-inoxidable"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Cocinas Con Mesada De Acero <span className="text-cyan-600">Inoxidable</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Cocinas con mesada de acero inoxidable para cocinas profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en cocinas con mesada de acero inoxidable. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar cocinas con mesada de acero inoxidable. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos cocinas con mesada de acero inoxidable diseñadas específicamente para cocinas profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con acero inoxidable 304 de grado alimenticio, nuestras cocinas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para restaurantes,
              bares, cafeterías y cualquier establecimiento que requiera estándares higiénicos profesionales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Cocinas con mesada de acero inoxidable para cocinas profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras cocinas con mesada de acero inoxidable ofrecen higiene máxima y resistencia excepcional para cocinas
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas cocinas con mesada de acero inoxidable?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras cocinas están fabricadas con mesadas de acero inoxidable 304 de grado alimenticio que garantiza
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-cyan-50">Mesada de acero inoxidable 304 grado alimenticio</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
