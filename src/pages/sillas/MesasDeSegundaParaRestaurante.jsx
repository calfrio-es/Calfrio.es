...
export default function MesasDeSegundaParaRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas de segunda para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas de segunda mano revisadas y restauradas, resistentes y duraderas para restaurantes profesionales.",
      image: mesaBarAcero5,
    },
    {
    ...
    },
    {
      ...
      description: "Garantía de 1 año en estructura y acabados. Resistencia y durabilidad certificada.",
      image: mesaBar5,
    },
  ]
  ...
  const faqs = [
    {
      question: "¿Qué tipo de mesas de segunda mano ofrecen?",
      answer:
        "Ofrecemos mesas revisadas, restauradas y garantizadas, con diferentes materiales como madera, metal y plástico, todas en perfectas condiciones de uso.",
    },
    {
      question: "¿Las mesas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas de segunda mano resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en restaurantes profesionales sin deteriorarse.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas De Segunda Para Restaurante"
        description="Mesas de segunda para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería."
        keywords="mesas segunda restaurante, mesas usadas restaurante, mobiliario segunda mano restaurante, mesas gastronomia, mesas bar segunda"
        canonical="/mesas-de-segunda-para-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas De Segunda Para <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas de segunda para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas de segunda para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas de segunda para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas de segunda mano revisadas y restauradas para restaurantes profesionales en el sector
              de la hostelería y gastronomía. Todas nuestras mesas pasan por rigurosos controles de calidad y
              garantizan higiene máxima, resistencia y facilidad de limpieza. Ideales para restaurantes,
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas de segunda para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas de segunda ofrecen higiene máxima y resistencia excepcional para restaurantes
                  profesionales. Superficies revisadas que facilitan la limpieza y evitan la acumulación de bacterias.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas de segunda para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas de segunda mano están revisadas y garantizadas, ofreciendo
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-cyan-50">Mesas revisadas y restauradas</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
