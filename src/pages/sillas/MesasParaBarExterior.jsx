...
export default function MesasParaBarExterior() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas para bar exterior. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con materiales resistentes a la intemperie, duraderas para exteriores.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Las mesas son resistentes a la lluvia y el sol?",
      answer:
        "Sí, nuestras mesas para exterior están tratadas con materiales resistentes a la intemperie, lluvia, sol y cambios de temperatura, ideales para terrazas y espacios al aire libre.",
    },
    {
      question: "¿Qué tipos de materiales ofrecen para exterior?",
      answer:
        "Ofrecemos mesas de aluminio, hierro forjado tratado, plástico resistente y madera tratada para exterior, todos con protección UV y antióxido.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Para Bar Exterior"
        description="Mesas para bar exterior resistentes a la intemperie. Higiene, resistencia y durabilidad máxima. Ideales para terrazas."
        keywords="mesas bar exterior, mesas terraza bar, mobiliario exterior bar, mesas resistente intemperie, mesas inox exterior"
        canonical="/mesas-para-bar-exterior"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Para Bar <span className="text-cyan-600">Exterior</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas para bar exterior resistentes a la intemperie. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas para bar exterior. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas para bar exterior. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas para bar exterior diseñadas específicamente para terrazas y espacios al aire libre en el sector
              de la hostelería. Fabricadas con materiales resistentes a la intemperie, nuestras mesas
              garantizan higiene máxima, resistencia a la lluvia, sol y cambios de temperatura. Ideales para bares,
              restaurantes y cualquier establecimiento con terraza exterior.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas para bar exterior resistentes a la intemperie"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas para bar exterior ofrecen higiene máxima y resistencia excepcional a la intemperie.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas para bar exterior?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas para exterior están fabricadas con materiales resistentes a la intemperie que garantizan
                  higiene máxima y resistencia a lluvia, sol y cambios de temperatura. Diseñadas para durar años al aire libre.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Materiales resistentes a la intemperie</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
