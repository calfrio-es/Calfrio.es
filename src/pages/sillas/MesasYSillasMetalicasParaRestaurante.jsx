...
export default function MesasYSillasMetalicasParaRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas metálicas para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con metales resistentes de primera calidad para restaurantes.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario metálico.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipos de metales utilizan?",
      answer:
        "Utilizamos acero inoxidable 304, hierro forjado tratado y aluminio, todos con tratamientos anticorrosivos y acabados profesionales para uso en restaurantes.",
    },
    {
      question: "¿Las mesas y sillas metálicas son resistentes al desgaste?",
      answer:
        "Sí, nuestras mesas y sillas metálicas están diseñadas para el uso intensivo diario de restaurantes, con tratamientos que evitan la oxidación y mantienen su apariencia profesional.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Metalicas Para Restaurante"
        description="Mesas y sillas metálicas para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería."
        keywords="mesas sillas metalicas restaurante, mesas metal restaurante, mobiliario metalico restaurante, mesas gastronomia metal, mesas inox restaurante"
        canonical="/mesas-y-sillas-metalicas-para-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Metálicas Para <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas metálicas para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas metálicas para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas metálicas para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas metálicas diseñadas específicamente para restaurantes profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con metales resistentes de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para restaurantes,
              bares, cafeterías y cualquier establecimiento que requiera estándares higiénicos profesionales con diseño industrial.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas metálicas para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas metálicas ofrecen higiene máxima y resistencia excepcional para restaurantes.
                  Superficies resistentes que facilitan la limpieza y evitan la acumulación de bacterias.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas metálicas para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas están fabricadas con metales resistentes de primera calidad que garantizan
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-cyan-50">Metales resistentes y duraderos</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
