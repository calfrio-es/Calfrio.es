...
export default function SillasCafeteriaVintage() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas vintage para cafetería. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas vintage fabricadas con materiales nobles y acabados artesanales para cafeterías.",
  ...
  const faqs = [
    {
      question: "¿Qué estilos vintage ofrecen para cafeterías?",
      answer:
        "Ofrecemos una amplia colección de estilos vintage incluyendo sillas de estilo industrial, art déco, años 50, años 70, estilo francés y otros diseños clásicos restaurados o fabricados con técnicas tradicionales.",
    },
    {
      question: "¿Las sillas vintage son cómodas para largas estancias?",
      answer:
        "Sí, nuestras sillas vintage están diseñadas con ergonomía moderna manteniendo el estilo clásico. Incluyen asientos acolchados y respaldos apropiados para la comodidad de tus clientes.",
    },
    {
      question: "¿Cuánto tiempo dura la entrega?",
      answer:
        "La entrega estándar es de 24-48 horas para modelos en stock. Para pedidos personalizados con estilos vintage específicos, coordinamos plazos según la disponibilidad.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Sillas Cafeteria Vintage"
        description="Sillas vintage para cafetería. Estilo clásico y elegante para ambientes acogedores. Mobiliario con personalidad única."
        keywords="sillas cafeteria vintage, sillas vintage cafetería, mobiliario vintage, sillas estilo clásico, sillas retro cafetería"
        canonical="/sillas-cafeteria-vintage"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Sillas Cafeteria <span className="text-cyan-600">Vintage</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas con estilo vintage para cafeterías. Elegancia clásica y personalidad única para tu establecimiento
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas vintage para cafetería. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas vintage para cafetería. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Descubre nuestra colección exclusiva de sillas vintage para cafetería, diseñadas para aportar carácter y personalidad
              única a tu establecimiento. Cada pieza combina el encanto de estilos clásicos con comodidad moderna, creando
              ambientes acogedores que invitan a los clientes a quedarse más tiempo disfrutando de tu café.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas vintage para cafetería en establecimiento elegante"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas vintage para cafetería combinan el encanto de épocas pasadas con comodidad moderna,
                  creando ambientes únicos que hacen de tu cafetería un lugar especial.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas sillas vintage para tu cafetería?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas vintage para cafetería con diseño clásico"
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras sillas vintage para cafetería están fabricadas con materiales de primera calidad que resisten el uso intensivo
                  de entornos hosteleros. Diseñadas para durar años manteniendo su belleza clásica.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Materiales nobles y acabados artesanales</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
