...
export default function SillaBar() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas para bar. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas fabricadas con materiales de primera calidad y diseño moderno para hostelería.",
  ...
  const faqs = [
    {
      question: "¿Qué alturas tienen las sillas para bar?",
      answer:
        "Nuestras sillas para bar tienen alturas estándar de 75-80cm desde el suelo hasta el asiento, perfectas para barras con alturas de 110-115cm. También ofrecemos opciones personalizadas según tus necesidades específicas.",
    },
    {
      question: "¿Son sillas apilables?",
      answer:
        "Sí, la mayoría de nuestros modelos de sillas para bar son apilables, lo que facilita el almacenamiento y la limpieza del local. Las sillas apilables pueden apilarse hasta 10-12 unidades según el modelo.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <SEO
        title="Silla Bar"
        description="Sillas para bar de alta calidad. Diseño moderno y resistente para hostelería. Comodidad y durabilidad garantizadas."
        keywords="silla bar, sillas para bar, mobiliario bar, sillas hostelería, sillas modernas bar"
        canonical="/silla-bar"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Silla <span className="text-cyan-600">Bar</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas diseñadas específicamente para barras de bar. Comodidad, resistencia y diseño moderno para tu establecimiento
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas para bar. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas para bar. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una amplia gama de sillas para bar diseñadas específicamente para el sector hostelero.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas para bar en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas para bar combinan diseño contemporáneo con ergonomía perfecta, creando espacios
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas para bar con diseño funcional"
