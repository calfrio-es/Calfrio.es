...
export default function MesasYSillasParaTaquerias() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas para taquerías. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
    ...
    },
    {
      ...
      description: "Servicio de montaje incluido con nuestros técnicos especializados en taquerías.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipo de mesas recomiendan para taquerías?",
      answer:
        "Recomendamos mesas resistentes a salsas y derrames, fáciles de limpiar, con diseños que combinen con la decoración mexicana tradicional y permitan una rápida rotación de clientes.",
    },
    {
      question: "¿Son adecuadas para servicio rápido?",
      answer:
        "Sí, nuestras mesas y sillas para taquerías están diseñadas para servicio rápido, con superficies impermeables y estructuras que facilitan la limpieza entre servicios.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Taquerias"
        description="Mesas y sillas para taquerías profesionales. Higiene, resistencia y durabilidad máxima. Ideales para comida mexicana."
        keywords="mesas sillas taquerias, mesas taquerias restaurante, mobiliario taquerias, mesas gastronomia mexicana, mesas bar taquerias"
        canonical="/mesas-y-sillas-para-taquerias"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para <span className="text-cyan-600">Taquerías</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas para taquerías profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas para mi taquerías. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas para mi taquerías. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas diseñadas específicamente para taquerías y restaurantes de comida mexicana en el sector
              de la gastronomía especializada. Fabricadas con materiales resistentes a salsas y especias, nuestras mesas y sillas
              garantizan higiene máxima, resistencia y facilidad de limpieza. Ideales para taquerías tradicionales,
              modernas y cualquier establecimiento que sirva tacos y comida mexicana auténtica.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas para taquerías profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas para taquerías ofrecen higiene máxima y resistencia excepcional a salsas y especias.
                  Superficies impermeables que facilitan la limpieza y mantienen la autenticidad mexicana.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas para tu taquerías?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas para taquerías están fabricadas con materiales resistentes a salsas y especias que garantizan
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Servicio rápido y eficiente</span>
                  </li>
                </ul>
              </div>
            </div>
