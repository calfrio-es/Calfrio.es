...
export default function SillasAltasParaBarra() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas altas para barra. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas altas fabricadas con materiales de primera calidad y diseño moderno.",
  ...
  const faqs = [
    {
      question: "¿Qué altura tienen las sillas altas para barra?",
      answer:
        "Nuestras sillas altas para barra tienen alturas estándar de 75-80cm desde el suelo hasta el asiento, perfectas para barras con alturas de 110-115cm. Esta medida permite una ergonomía ideal para consumir en barra.",
    },
    {
      question: "¿Vienen con o sin respaldo?",
      answer:
        "Ofrecemos ambos modelos: sillas altas con respaldo completo para mayor comodidad en estancias prolongadas, y taburetes altos sin respaldo para un diseño más minimalista y facilidad de almacenamiento.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Sillas Altas Para Barra"
        description="Sillas altas para barra de calidad premium. Diseño moderno y resistente para bares y restaurantes."
        keywords="sillas altas para barra, sillas barra altas, taburetes altos, mobiliario barra, sillas bar altas"
        canonical="/sillas-altas-para-barra"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Sillas Altas Para <span className="text-cyan-600">Barra</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas altas diseñadas específicamente para barras. Comodidad, estabilidad y diseño moderno para tu establecimiento
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas altas para barra. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas altas para barra. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una amplia gama de sillas altas para barra diseñadas específicamente para el sector hostelero.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas altas para barra en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas altas para barra combinan diseño contemporáneo con ergonomía perfecta y máxima estabilidad,
                  creando espacios cómodos que invitan a tus clientes a permanecer más tiempo.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas sillas altas para tu barra?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas altas para barra con diseño funcional"
