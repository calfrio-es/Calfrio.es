...
export default function MesasYSillasDeMaderaParaBar() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas de madera para bar. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con madera de primera calidad, resistentes y duraderas para bares.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Utilizamos maderas nobles como roble, nogal, haya y pino tratado, con acabados naturales o tintados, resistentes al desgaste y fáciles de mantener.",
    },
    {
      question: "¿Las mesas y sillas de madera necesitan mantenimiento especial?",
      answer:
        "Nuestras mesas y sillas incluyen tratamiento protector, pero recomendamos limpieza regular con productos específicos para madera para mantener su belleza natural.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas De Madera Para Bar"
        description="Mesas y sillas de madera para bares profesionales. Higiene, resistencia y durabilidad máxima. Ideales para decoración natural."
        keywords="mesas sillas madera bar, mesas madera bar, mobiliario madera bar, mesas gastronomia madera, mesas madera bar"
        canonical="/mesas-y-sillas-de-madera-para-bar"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas De Madera Para <span className="text-cyan-600">Bar</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas de madera para bares profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas de madera para mi bar. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas de madera para mi bar. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas de madera diseñadas específicamente para bares profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con maderas nobles de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia al desgaste y facilidad de limpieza. Ideales para bares,
              pubs, cafeterías y cualquier establecimiento que busque un ambiente cálido y natural.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas de madera para bares profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas de madera ofrecen higiene máxima y resistencia excepcional para bares.
                  Superficies tratadas que facilitan la limpieza y mantienen la belleza natural de la madera.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas de madera para tu bar?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas están fabricadas con maderas nobles de primera calidad que garantizan
                  higiene máxima y resistencia al desgaste. Diseñadas para durar años en entornos de alta exigencia.
                </p>
