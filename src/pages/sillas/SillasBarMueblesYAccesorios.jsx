...
export default function SillasBarMueblesYAccesorios() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas para bar con muebles y accesorios. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas fabricadas con materiales de primera calidad con muebles y accesorios incluidos.",
      image: bancoBarAcero4,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario completo.",
  ...
  const faqs = [
    {
      question: "¿Qué incluyen los muebles y accesorios?",
      answer:
        "Nuestros paquetes incluyen sillas, mesas auxiliares, reposapiés, organizadores de cables, protectores de piso y otros accesorios que complementan perfectamente el mobiliario del bar.",
    },
    {
      question: "¿Los accesorios son compatibles con cualquier silla?",
      answer:
        "Diseñamos nuestros accesorios específicamente para ser compatibles con nuestras sillas. Si tienes sillas de otras marcas, podemos asesorarte sobre adaptaciones personalizadas.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Sillas Bar Muebles Y Accesorios"
        description="Sillas para bar con muebles y accesorios completos. Soluciones integrales para mobiliario hostelero."
        keywords="sillas bar muebles accesorios, mobiliario bar completo, accesorios bar, sillas con complementos, mobiliario hostelería"
        canonical="/sillas-bar-muebles-y-accesorios"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Sillas Bar Muebles Y <span className="text-cyan-600">Accesorios</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas para bar con muebles y accesorios incluidos. Soluciones completas para tu establecimiento hostelero
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas para bar con muebles y accesorios. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas para bar con muebles y accesorios. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos paquetes completos de sillas para bar que incluyen muebles y accesorios esenciales para el funcionamiento
              óptimo de tu establecimiento. Nuestros conjuntos están diseñados para proporcionar comodidad, funcionalidad y estilo,
              con todos los elementos necesarios para crear espacios acogedores y prácticos en bares y restaurantes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas para bar con muebles y accesorios en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestros paquetes de sillas con muebles y accesorios ofrecen soluciones integrales que incluyen todo lo necesario
                  para equipar completamente tu zona de bar con estilo y funcionalidad.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas sillas con muebles y accesorios?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas para bar con muebles y accesorios funcionales"
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestros conjuntos de sillas con muebles y accesorios están fabricados con materiales de primera calidad que resisten el uso intensivo
