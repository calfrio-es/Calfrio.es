...
export default function MesasConSombrillaParaRestaurante() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas con sombrilla para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas con sombrillas fabricadas con materiales de primera calidad, resistentes y duraderas para restaurantes profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipos de sombrillas ofrecen?",
      answer:
        "Ofrecemos sombrillas de diferentes tamaños y materiales (acrílico, PVC, tela), con estructuras resistentes al viento y agua, ideales para terrazas de restaurantes.",
    },
    {
      question: "¿Las mesas y sombrillas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas y sombrillas resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en restaurantes profesionales sin deteriorarse.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, todas nuestras mesas con sombrilla incluyen instalación profesional por parte de nuestro equipo técnico especializado. Nos aseguramos de que queden perfectamente niveladas y listas para su uso inmediato.",
    },
  ]
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Con Sombrilla Para Restaurante"
        description="Mesas con sombrilla para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para terrazas."
        keywords="mesas sombrilla restaurante, mesas terraza restaurante, mobiliario terraza restaurante, mesas gastronomia, mesas inox restaurante"
        canonical="/mesas-con-sombrilla-para-restaurante"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Con Sombrilla Para <span className="text-cyan-600">Restaurante</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas con sombrilla para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas con sombrilla para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas con sombrilla para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas con sombrilla diseñadas específicamente para restaurantes profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con materiales de primera calidad, nuestras mesas y sombrillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para terrazas de restaurantes,
              bares al aire libre y cualquier establecimiento que requiera comodidad y protección solar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas con sombrilla para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas con sombrilla ofrecen higiene máxima y resistencia excepcional para restaurantes
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas con sombrilla para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas con sombrilla están fabricadas con materiales de primera calidad que garantizan
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-cyan-50">Materiales de alta calidad y resistencia</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
