...
export default function MesasYSillasCocteleras() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas cocteleras. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con materiales de primera calidad, resistentes y duraderas para coctelería.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario de coctelería.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué características tienen las mesas cocteleras?",
      answer:
        "Las mesas cocteleras son altas (75-85cm) con diseños elegantes, perfectas para cócteles y ambientes sofisticados, con espacio para vasos y cócteles.",
    },
    {
      question: "¿Son adecuadas para eventos especiales?",
      answer:
        "Sí, nuestras mesas y sillas cocteleras son ideales para eventos, bodas, fiestas privadas y espacios de coctelería premium.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Cocteleras"
        description="Mesas y sillas cocteleras profesionales. Higiene, resistencia y durabilidad máxima. Ideales para eventos y coctelería premium."
        keywords="mesas sillas cocteleras, mesas bar cocteles, mobiliario cocteleria, mesas gastronomia bar, mesas inox cocteleras"
        canonical="/mesas-y-sillas-cocteleras"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas <span className="text-cyan-600">Cocteleras</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas cocteleras profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas cocteleras. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas cocteleras. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas cocteleras diseñadas específicamente para espacios de coctelería premium y eventos especiales en el sector
              de la hostelería y gastronomía. Fabricadas con materiales de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para bares de cócteles,
              eventos, bodas y cualquier establecimiento que busque un ambiente sofisticado.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas cocteleras profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas cocteleras ofrecen higiene máxima y resistencia excepcional para espacios premium.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas cocteleras?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas cocteleras están fabricadas con materiales de primera calidad que garantizan
