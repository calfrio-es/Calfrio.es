...
export default function SillasDeBar() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas de bar. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas de bar fabricadas con materiales de primera calidad y diseño moderno.",
  ...
  const faqs = [
    {
      question: "¿Qué tipos de sillas de bar ofrecen?",
      answer:
        "Ofrecemos una amplia variedad incluyendo sillas altas, taburetes, sillas con respaldo, sillas tapizadas, sillas de madera, metal, aluminio y plástico. Cada tipo está diseñado para diferentes estilos de decoración y necesidades de comodidad.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <SEO
        title="Sillas De Bar"
        description="Sillas de bar de alta calidad. Diseño moderno y resistente para hostelería. Comodidad garantizada."
        keywords="sillas de bar, sillas bar modernas, mobiliario bar, sillas hostelería, sillas altas bar"
        canonical="/sillas-de-bar"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Sillas De <span className="text-cyan-600">Bar</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas diseñadas específicamente para bares. Comodidad, resistencia y diseño moderno para tu establecimiento
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas de bar. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas de bar. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una amplia gama de sillas de bar diseñadas específicamente para el sector hostelero.
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas de bar en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas de bar combinan diseño contemporáneo con ergonomía perfecta, creando espacios
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas de bar con diseño funcional"
