...
export default function SillasBarraCocina() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras sillas para barra de cocina. Entrega en 24-48 horas.",
      image: sillaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Sillas fabricadas con materiales de primera calidad resistentes a ambientes de cocina.",
      image: bancoBarAcero4,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en ambientes hosteleros.",
  ...
  const faqs = [
    {
      question: "¿Son resistentes a la humedad y grasa de cocina?",
      answer:
        "Sí, nuestras sillas para barra de cocina están fabricadas con materiales especiales resistentes a la humedad, grasa y productos de limpieza utilizados en cocinas profesionales.",
    },
    {
      question: "¿Qué medidas tienen para barra de cocina?",
      answer:
        "Ofrecemos sillas con alturas de 75-80cm perfectas para barras de cocina con alturas estándar de 110-115cm. También disponemos de opciones personalizadas según tus necesidades específicas.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Sillas Barra Cocina"
        description="Sillas para barra de cocina resistentes y funcionales. Diseño especializado para ambientes hosteleros de alta demanda."
        keywords="sillas barra cocina, sillas cocina profesionales, mobiliario cocina, sillas barra hostelería, sillas resistentes humedad"
        canonical="/sillas-barra-cocina"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Sillas Barra <span className="text-cyan-600">Cocina</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas diseñadas específicamente para barras de cocina. Resistencia y funcionalidad para ambientes hosteleros
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, estoy interesado en sillas para barra de cocina. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+573167137081'
                const message = 'Hola, quiero comprar sillas para barra de cocina. ¿Me pueden ayudar con el proceso de compra?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos una línea especializada de sillas para barra de cocina diseñadas específicamente para resistir las condiciones
              exigentes de ambientes culinarios. Nuestras sillas combinan comodidad para el personal con máxima resistencia a la humedad,
              grasa, productos de limpieza y el uso intensivo diario característico de cocinas profesionales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={bancoBarModerno}
              alt="Sillas para barra de cocina en establecimiento moderno"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas para barra de cocina están diseñadas para resistir las condiciones más exigentes de ambientes culinarios,
                  manteniendo su funcionalidad y apariencia en cocinas profesionales de alta demanda.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas sillas para barra de cocina?</h2>
          ...
          <div className="overflow-hidden rounded-3xl bg-cyan-600 shadow-2xl">
            <div className="grid gap-0 md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <img
                  src={bancoBarAcero1}
                  alt="Sillas para barra de cocina con diseño funcional"
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras sillas para barra de cocina están fabricadas con materiales de primera calidad que resisten el uso intensivo
                  de entornos culinarios. Diseñadas para durar años manteniendo su comodidad y apariencia.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Resistentes a humedad y grasa</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
