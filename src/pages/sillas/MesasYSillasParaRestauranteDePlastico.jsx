...
export default function MesasYSillasParaRestauranteDePlastico() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas de plástico para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con plástico resistente para restaurantes.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario de plástico.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipos de plástico utilizan?",
      answer:
        "Utilizamos plásticos resistentes al impacto y a altas temperaturas, disponibles en diferentes colores, ideales para restaurantes con alto tráfico de clientes.",
    },
    {
      question: "¿Son las mesas y sillas de plástico resistentes al desgaste?",
      answer:
        "Sí, nuestras mesas y sillas están diseñadas específicamente para uso intensivo en restaurantes, resistiendo el desgaste diario y manteniendo su apariencia profesional por años.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Restaurante De Plastico"
        description="Mesas y sillas de plástico para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para alto tráfico."
        keywords="mesas sillas plastico restaurante, mesas plastico restaurante, mobiliario plastico restaurante, mesas gastronomia plastico, mesas bar plastico"
        canonical="/mesas-y-sillas-para-restaurante-de-plastico"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para Restaurante De <span className="text-cyan-600">Plástico</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas de plástico para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas de plástico para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas de plástico para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas de plástico diseñadas específicamente para restaurantes con alto tráfico de clientes en el sector
              de la hostelería y gastronomía. Fabricadas con plástico resistente de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia al desgaste y facilidad de limpieza. Ideales para restaurantes,
              cafeterías, comedores escolares y cualquier establecimiento que requiera mobiliario duradero y fácil mantenimiento.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas de plástico para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas de plástico ofrecen higiene máxima y resistencia excepcional al desgaste.
                  Superficies lisas que facilitan la limpieza y resisten el uso intensivo diario.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas de plástico para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas de plástico están fabricadas con materiales resistentes al desgaste que garantizan
                  higiene máxima y durabilidad. Diseñadas para durar años en entornos comerciales.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Plástico resistente al impacto</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
