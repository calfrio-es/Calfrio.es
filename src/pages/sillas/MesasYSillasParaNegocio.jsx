...
export default function MesasYSillasParaNegocio() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas para negocio. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con materiales resistentes para negocios profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipo de mesas recomiendan para diferentes negocios?",
      answer:
        "Ofrecemos mesas adaptadas a cada tipo de negocio: mesas altas para bares, mesas de comedor para restaurantes, mesas robustas para comercios con alto tráfico de clientes.",
    },
    {
      question: "¿Son adecuadas para uso comercial intensivo?",
      answer:
        "Sí, nuestras mesas y sillas están diseñadas específicamente para uso comercial diario, resistiendo el desgaste y manteniendo su apariencia profesional por años.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Negocio"
        description="Mesas y sillas para negocios profesionales. Higiene, resistencia y durabilidad máxima. Ideales para comercios."
        keywords="mesas sillas negocio, mesas negocio comercial, mobiliario comercial, mesas gastronomia negocio, mesas bar negocio"
        canonical="/mesas-y-sillas-para-negocio"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para <span className="text-cyan-600">Negocio</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas para negocios profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas para mi negocio. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas para mi negocio. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas diseñadas específicamente para negocios profesionales en el sector
              comercial. Fabricadas con materiales resistentes y duraderos, nuestras mesas y sillas
              garantizan higiene máxima, resistencia al desgaste y facilidad de limpieza. Ideales para comercios,
              oficinas, tiendas y cualquier establecimiento que requiera mobiliario funcional y profesional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas para negocios profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas para negocios ofrecen higiene máxima y resistencia excepcional al desgaste comercial.
                  Superficies duraderas que facilitan la limpieza y mantienen la profesionalidad.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas para tu negocio?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas para negocios están fabricadas con materiales resistentes al desgaste comercial que garantizan
                  higiene máxima y durabilidad. Diseñadas para durar años en entornos profesionales.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Resistentes al uso comercial intensivo</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Adecuadas para diferentes tipos de negocio</span>
                  </li>
                </ul>
              </div>
            </div>
