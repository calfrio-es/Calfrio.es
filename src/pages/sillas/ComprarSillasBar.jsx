...
export default function ComprarSillasBar() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Sillas fabricadas con materiales de primera calidad, resistentes y duraderas para bares profesionales.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Utilizamos materiales de alta calidad como acero inoxidable, madera maciza y plásticos resistentes, todos aprobados para uso en bares y restaurantes profesionales.",
    },
    {
      question: "¿Las sillas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras sillas resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en bares profesionales sin deteriorarse.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sí, todas nuestras sillas incluyen instalación profesional por parte de nuestro equipo técnico especializado. Nos aseguramos de que queden perfectamente niveladas y listas para su uso inmediato.",
    },
  ]
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Comprar Sillas Bar"
        description="Sillas para bares profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="sillas bar, sillas inox bar, mobiliario bar acero, sillas gastronomia, sillas inox bar"
        canonical="/comprar-sillas-bar"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Comprar Sillas <span className="text-cyan-600">Bar</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Sillas para bares profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en sillas para mi bar. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar sillas para mi bar. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos sillas diseñadas específicamente para bares profesionales en el sector
              de la hostelería y gastronomía. Fabricadas con materiales de primera calidad, nuestras sillas
              garantizan higiene máxima, resistencia a la corrosión y facilidad de limpieza. Ideales para bares,
              cafeterías, pubs y cualquier establecimiento que requiera estándares higiénicos profesionales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Sillas para bares profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras sillas ofrecen higiene máxima y resistencia excepcional para bares
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras sillas están fabricadas con materiales de primera calidad que garantizan
