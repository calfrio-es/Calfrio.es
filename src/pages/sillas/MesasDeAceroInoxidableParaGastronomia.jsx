...
export default function MesasDeAceroInoxidableParaGastronomia() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas de acero inoxidable para gastronomía. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con acero inoxidable de primera calidad, resistentes y duraderas para gastronomía profesional.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario de gastronomía.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "Utilizamos acero inoxidable 304 de grado alimenticio, resistente a la corrosión, fácil de limpiar y aprobado para uso en gastronomía profesional. Este material cumple con todas las normativas sanitarias.",
    },
    {
      question: "¿Las mesas son resistentes a productos químicos?",
      answer:
        "Sí, nuestras mesas de acero inoxidable resisten limpiadores químicos, desinfectantes y productos de limpieza agresivos utilizados en gastronomía profesional sin deteriorarse.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas De Acero Inoxidable Para Gastronomia"
        description="Mesas de acero inoxidable para gastronomía profesional. Higiene, resistencia y durabilidad máxima. Ideales para hostelería."
        keywords="mesas acero inoxidable gastronomia, mesas inox gastronomia, mobiliario gastronomia acero, mesas acero inoxidable hostelería, mesas inox bar"
        canonical="/mesas-de-acero-inoxidable-para-gastronomia"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas De Acero Inoxidable Para <span className="text-cyan-600">Gastronomía</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas de acero inoxidable para gastronomía profesional. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas de acero inoxidable para gastronomía. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas de acero inoxidable para gastronomía. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas de acero inoxidable diseñadas específicamente para gastronomía profesional en el sector
              de la hostelería. Fabricadas con acero inoxidable 304 de grado alimenticio, nuestras mesas
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas de acero inoxidable para gastronomía profesional"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas de acero inoxidable ofrecen higiene máxima y resistencia excepcional para gastronomía
                  profesional. Superficies lisas que facilitan la limpieza y evitan la acumulación de bacterias.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas de acero inoxidable para gastronomía?</h2>
