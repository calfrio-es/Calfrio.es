...
export default function MesasParaRestauranteVintage() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas para restaurante vintage. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas fabricadas con materiales vintage restaurados, resistentes y duraderas para restaurantes.",
      image: mesaBarAcero5,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué estilos vintage ofrecen?",
      answer:
        "Ofrecemos mesas en estilos vintage como años 50, 60, 70, industrial, retro y clásico, con acabados en madera maciza, metal patinado y diseños únicos.",
    },
    {
      question: "¿Las mesas vintage son restauradas?",
      answer:
        "Sí, todas nuestras mesas vintage pasan por un proceso de restauración profesional que preserva la autenticidad del diseño original mientras garantiza resistencia y funcionalidad.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Para Restaurante Vintage"
        description="Mesas para restaurante vintage con estilo retro. Higiene, resistencia y durabilidad máxima. Ideales para decoración nostálgica."
        keywords="mesas restaurante vintage, mesas retro restaurante, mobiliario vintage restaurante, mesas estilo años 50, mesas clásicas bar"
        canonical="/mesas-para-restaurante-vintage"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Para Restaurante <span className="text-cyan-600">Vintage</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas para restaurante vintage con estilo retro. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas para restaurante vintage. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas para restaurante vintage. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas para restaurante vintage diseñadas específicamente para espacios con decoración retro y nostálgica en el sector
              de la hostelería y gastronomía. Fabricadas con materiales vintage restaurados, nuestras mesas
              garantizan higiene máxima, resistencia y un toque único de estilo clásico. Ideales para restaurantes temáticos,
              cafeterías vintage y cualquier establecimiento que busque un ambiente retro.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas para restaurante vintage con estilo retro"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas vintage ofrecen higiene máxima y resistencia excepcional para restaurantes retro.
                  Superficies restauradas que facilitan la limpieza y mantienen el encanto vintage.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas para restaurante vintage?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas vintage están fabricadas con materiales restaurados de calidad que garantizan
                  higiene máxima y resistencia. Diseñadas para durar años manteniendo su encanto retro.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Materiales vintage restaurados</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
