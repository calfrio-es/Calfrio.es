...
export default function MesasYSillasParaRestauranteDeMadera() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas de madera para restaurante. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con maderas nobles para restaurantes.",
      image: mesaBarAcero5,
    },
    {
    ...
    },
    {
      ...
      description: "Garantía de 2 años en estructura y acabados. Tratamiento protector certificado.",
      image: mesaBar5,
    },
  ]
  ...
  const faqs = [
    {
      ...
      answer:
        "Utilizamos maderas nobles como roble, nogal, haya y cerezo, con acabados naturales o tintados, todas certificadas y tratadas para uso en restaurantes.",
    },
    {
      question: "¿Necesitan mantenimiento especial las mesas de madera?",
      answer:
        "Recomendamos limpieza regular con productos específicos para madera y tratamientos periódicos para mantener la belleza natural y resistencia del material.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Restaurante De Madera"
        description="Mesas y sillas de madera para restaurantes profesionales. Higiene, resistencia y durabilidad máxima. Ideales para ambientes cálidos."
        keywords="mesas sillas madera restaurante, mesas madera restaurante, mobiliario madera restaurante, mesas gastronomia madera, mesas bar madera"
        canonical="/mesas-y-sillas-para-restaurante-de-madera"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para Restaurante De <span className="text-cyan-600">Madera</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas de madera para restaurantes profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas de madera para mi restaurante. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas de madera para mi restaurante. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas de madera diseñadas específicamente para restaurantes que buscan ambientes cálidos y naturales en el sector
              de la hostelería y gastronomía. Fabricadas con maderas nobles de primera calidad, nuestras mesas y sillas
              garantizan higiene máxima, resistencia al desgaste y facilidad de limpieza. Ideales para restaurantes,
              bares, cafeterías y cualquier establecimiento que busque crear ambientes acogedores con materiales naturales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas de madera para restaurantes profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas de madera ofrecen higiene máxima y resistencia excepcional.
                  Superficies naturales tratadas que facilitan la limpieza y mantienen la belleza de la madera.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas de madera para tu restaurante?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas de madera están fabricadas con maderas nobles certificadas que garantizan
                  higiene máxima y resistencia al desgaste. Diseñadas para crear ambientes cálidos y naturales.
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Tratamiento protector profesional</span>
                  </li>
                </ul>
              </div>
            </div>
