...
export default function MesasYSillasParaPolleria() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesas y sillas para pollería. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "Calidad Premium",
      description: "Mesas y sillas fabricadas con materiales resistentes para pollos y alimentos grasos.",
      image: mesaBarAcero5,
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Instalación Profesional",
      description: "Servicio de montaje incluido con nuestros técnicos especializados en mobiliario para pollerías.",
      image: mesaBar3,
    },
    {
  ...
  const faqs = [
    {
      question: "¿Qué tipo de mesas recomiendan para pollerías?",
      answer:
        "Recomendamos mesas resistentes a grasas y manchas, fáciles de limpiar, con superficies impermeables que soporten el uso intensivo típico de las pollerías.",
    },
    {
      question: "¿Son adecuadas para exteriores y delivery?",
      answer:
        "Sí, nuestras mesas y sillas para pollerías están diseñadas para exteriores, con tratamientos resistentes que facilitan la limpieza rápida y frecuente.",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesas Y Sillas Para Polleria"
        description="Mesas y sillas para pollerías profesionales. Higiene, resistencia y durabilidad máxima. Ideales para alimentos grasos."
        keywords="mesas sillas polleria, mesas pollo restaurante, mobiliario polleria, mesas gastronomia pollo, mesas bar polleria"
        canonical="/mesas-y-sillas-para-polleria"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesas Y Sillas Para <span className="text-cyan-600">Pollería</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesas y sillas para pollerías profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesas y sillas para mi pollería. ¿Podrían asesorarme?'
            ...
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, quiero comprar mesas y sillas para mi pollería. ¿Me pueden ayudar?'
                const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`
                window.open(whatsappUrl, '_blank')
              }}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesas y sillas diseñadas específicamente para pollerías y asaderos de pollo en el sector
              de la restauración rápida. Fabricadas con materiales resistentes a grasas y manchas, nuestras mesas y sillas
              garantizan higiene máxima, resistencia y facilidad de limpieza. Ideales para pollerías,
              asaderos, restaurantes de comida rápida y cualquier negocio que sirva alimentos grasos.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesas y sillas para pollerías profesionales"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-900/90 to-cyan-700/70 flex items-center">
              <div className="px-8 sm:px-16 max-w-2xl">
                ...
                <p className="text-lg sm:text-xl text-cyan-50">
                  Nuestras mesas y sillas para pollerías ofrecen higiene máxima y resistencia excepcional a grasas y manchas.
                  Superficies impermeables que facilitan la limpieza y soportan alimentos grasos.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">¿Necesitas mesas y sillas para tu pollería?</h2>
            ...
            <div className="grid gap-0 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mb-6 text-pretty text-lg leading-relaxed text-cyan-50">
                  Nuestras mesas y sillas para pollerías están fabricadas con materiales resistentes a grasas y manchas que garantizan
                  higiene máxima y durabilidad. Diseñadas para durar años en ambientes de comida rápida.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Resistentes a grasas y manchas</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-cyan-200" />
                    <span className="text-cyan-50">Adecuadas para exteriores y delivery</span>
                  </li>
                </ul>
              </div>
            </div>
