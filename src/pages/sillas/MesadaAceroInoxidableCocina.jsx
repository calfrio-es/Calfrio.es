...
export default function MesadaAceroInoxidableCocina() {
  ...
  const benefits = [
    {
      ...
      description: "Disponibilidad inmediata de nuestras mesadas de acero inoxidable para cocina. Entrega en 24-48 horas.",
      image: mesaBarAcero2,
    },
    {
  ...
  return (
    <div className="w-full min-h-screen">
      <Header />
      <SEO
        title="Mesada Acero Inoxidable Cocina"
        description="Mesadas de acero inoxidable para cocinas profesionales. Higiene, resistencia y durabilidad máxima. Ideales para hostelería y gastronomía."
        keywords="mesadas acero inoxidable cocina, mesadas inox cocinas, mobiliario cocina acero, mesadas acero inoxidable gastronomia, mesadas inox bar"
        canonical="/mesada-acero-inoxidable-cocina"
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Mesada Acero Inoxidable <span className="text-cyan-600">Cocina</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto">
            Mesadas de acero inoxidable para cocinas profesionales. Higiene máxima y resistencia excepcional
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                const phoneNumber = '+34632075370'
                const message = 'Hola, estoy interesado en mesadas de acero inoxidable para mi cocina. ¿Podrían asesorarme?'
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 border-t-4 border-cyan-500">
            <p className="text-lg text-gray-700 leading-relaxed">
              Ofrecemos mesadas de acero inoxidable diseñadas específicamente para cocinas profesionales en el sector
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img
              src={mesaBarAcero6}
              alt="Mesadas de acero inoxidable para cocinas profesionales"
